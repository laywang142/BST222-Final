...
Figure \@ref(fig:edubar) compares the group of mothers who weaned their babies versus those who did not wean their babies. Those who didnn't wean their children had higher propportion of mothers who went some college in their education background. Mothers who weaned their babies had a higher proportion of those who did not finish high school. 
...
```{r boxbfeedstat, fig.align='center', fig.height=3.5, message=FALSE, warning=FALSE, fig.cap="Box Plot of Race Distribution by Breastfeedin Status"}
...
```{r kmpov, fig.align='center', fig.height=3.5, message=FALSE, warning=FALSE, fig.cap="KM Curve - Poverty"}
KMcurves_poverty <- survfit(surv ~ poverty, data = df)
plot(KMcurves_poverty, col = 1:2, main = "KM Curves for Poverty")
legend("topright", legend = c("Yes", "No"), col = 1:2, lty = 1)
```
