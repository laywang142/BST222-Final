...
The Schoenfeld residual plots shown in Figures \@ref(fig:resa), \@ref(fig:resb), and \@ref(fig:resc) do not exhibit any clear signs of non-proportionality because the residuals are randomly distributed around the y=0 lines in both plots. These results suggest that the evidence is insufficient to conclude that the hazards are non-proportional for the two models. 
