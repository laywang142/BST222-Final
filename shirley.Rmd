...
full_mod <- coxph(surv~race*poverty*smoke, data=df) ##first order model with 9 predictors 
library(MASS)

#forward+backward selection based on AIC: 
stepAIC(none_mod, scope=list(upper=full_mod, lower = ~1), direction="both", k=2, trace = TRUE)
```
